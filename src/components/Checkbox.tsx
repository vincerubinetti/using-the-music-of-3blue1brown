...
export default function Checkbox({
  ...
  return (
    <label className="flex cursor-pointer items-center justify-start gap-4 pr-2 text-left leading-relaxed accent-sky-500 transition-colors hover:bg-gray-800">
